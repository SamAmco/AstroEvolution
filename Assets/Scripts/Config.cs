...
public class Config
{
	public const float ENGINE_POWER = 50;
	public const float BLOCK_MASS = 0.1f;
	public const float BLOCK_DRAG = 0.6f;
	public const float BLOCK_ANGULAR_DRAG = 0.5f;
	...
	public const float MAX_DISTANCE_TO_CHANGE_TARGET = 49000;
	public const float MAX_RETARGET_INTERVAL = 3;
